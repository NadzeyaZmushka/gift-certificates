...
//        when(tagRepository.findAll(, any(FindAllSpecification.class), )).thenReturn(tags);
//        //when
...
//        when(tagRepository.findOne(any(FindByIdSpecification.class))).thenReturn(Optional.of(tag));
//        //when
...
//        //given
//        Tag tag = new Tag(1L, "tag");
//        when(tagRepository.findOne(any(TagFindByNameSpecification.class))).thenReturn(Optional.of(tag));
//        //when
...
//        //given
//        List<Tag> tags = Arrays.asList(new Tag(1L, "tag"), new Tag());
//        when(tagRepository.findAll(, any(TagFindByCertificateIdSpecification.class), )).thenReturn(tags);
//        //when
...
//        when(tagRepository.findAll(, any(TagFindByNamesSpecification.class), )).thenReturn(tags);
//        //when
